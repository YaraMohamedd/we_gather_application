  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        toolbarHeight: 70,
        title: Text(' Events',style: TextStyle(color: Colors.white,fontSize: 25),),
      ),
      drawer: MyDrawer(),
        ...
        child: Column(
          children: [
            ...
            Container(
                ...
                child: Row(
                  children: [
                    Text('Most Sharing',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold),),
                  ],
                )),
            Container(
            ...
            Container(
                ...
                child: Row(
                  children: [
                    Text('All Events ',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold),),
                  ],
                )),
            Container(
              margin: EdgeInsets.only(left: 10,top: 20),
                  ...
                  Padding(
                    ...
                    child: Stack(
                      children: [
                        ClipRRect(
                          borderRadius: BorderRadius.only(topLeft: Radius.circular(15),topRight: Radius.circular(15)),
                          child: Image.asset('assets/unsplash4.jpg',height: 150,width: MediaQuery.of(context).size.width*.9,fit: BoxFit.cover),),
                        Transform.translate(
